...
This is a combined docker-compose file that includes everything needed to host your own radarr, sonarr, prowlarr, bazarr, sabnzbd, qbitorrent and tailscale with Mullvad VPN exit node.
